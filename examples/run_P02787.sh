...
mkdir -p ~/EMBL-EBI/funclan_work/P02787/ca_distances
mkdir -p ~/EMBL-EBI/funclan_work/P02787/distance_differences
mkdir -p ~/EMBL-EBI/funclan_work/P02787/distance_difference_maps
mkdir -p ~/EMBL-EBI/funclan_work/P02787/cluster_results
# Remove files from previous executions
rm ~/EMBL-EBI/funclan_work/P02787/ca_distances/*
rm ~/EMBL-EBI/funclan_work/P02787/distance_differences/*
rm ~/EMBL-EBI/funclan_work/P02787/distance_difference_maps/*
rm ~/EMBL-EBI/funclan_work/P02787/cluster_results/*
...
python3 run_find_conformers.py -u "P02787" \
    ...
    -m /home/jellaway/EMBL-EBI/funclan_work/P02787_updated/7ffm_updated.cif A \
    -m /home/jellaway/EMBL-EBI/funclan_work/P02787_updated/7ffu_updated.cif A \
    -m /home/jellaway/EMBL-EBI/funclan_work/P02787_updated/7q1l_updated.cif A B \
    -c ~/EMBL-EBI/funclan_work/P02787/ca_distances/ \
    -d ~/EMBL-EBI/funclan_work/P02787/distance_differences/ \
    -s ~/EMBL-EBI/funclan_work/P02787/cluster_results/ \
    -g ~/EMBL-EBI/funclan_work/P02787/cluster_results/ png svg
